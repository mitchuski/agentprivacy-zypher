...
## 🔧 Step 1: Setup Keys and Configuration
...
- Export spending key (for Signer) ⚠️ **KEEP SECURE**
...
DONATION_SPENDING_KEY=zxsecrets1...  # ⚠️ SECURE THIS!
...
This tests:
1. ✅ Zebra node connection
2. ✅ IPFS spellbook access
3. ✅ Viewing key functionality
4. ✅ Semantic matching
5. ✅ Golden split calculation
6. ✅ Inscription builder
7. ✅ Oracle service health
8. ✅ Signer service health
...
--------------------------------------
✓ Connected to node at block 2500000

[2] Testing IPFS spellbook access
--------------------------------------
✓ Spellbook accessible at https://...
✓ Spellbook contains 12 acts

[3] Testing viewing key functionality
--------------------------------------
✓ Viewing key functional

[4] Testing semantic proverb matching
--------------------------------------
✓ Proverb match score: 0.8234 (above 0.75 threshold)
...
[Oracle] ✓ VERIFIED - Signaling Signer
[Oracle] POST http://signer:3001/verify
```

---

## ⚖️ Step 5: Verify Golden Split
...
[Signer] Split: 0.00618 ZEC → t-address, 0.00382 ZEC → z-address
