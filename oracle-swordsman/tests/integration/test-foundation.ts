...
async function testFoundation() {
  ...
  console.log('   NEAR Cloud AI API Key:', config.near.mageApiKey.substring(0, 10) + '...');
  console.log('   Spellbook CID:', config.ipfs.spellbookCid);
  console.log('   Zcash Network:', config.zcash.network);
  console.log('   Zcash RPC Port:', config.zcash.rpcPort);
